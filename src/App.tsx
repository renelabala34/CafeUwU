        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="flex items-center gap-1 text-cream-100 text-xs">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight mb-4">
              ¡MAS!
              <span className="block text-cream-100 text-2xl sm:text-3xl lg:text-4xl font-bold mt-2">
                {businessInfo.tagline}
              </span>
            </h2>
            <p className="text-cream-100/90 text-sm sm:text-base leading-relaxed max-w-lg mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white text-xs font-medium">
      ...
      <footer className="bg-tomato-900 text-cream-100 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="font-black text-white mb-3 text-sm">Menú</h4>
              <ul className="space-y-2 text-sm text-cream-300/70">
                <li className="hover:text-white cursor-pointer transition-colors">Ofertas sin freír</li>
                <li className="hover:text-white cursor-pointer transition-colors">Preparados</li>
                <li className="hover:text-white cursor-pointer transition-colors">Croquetas</li>
                <li className="hover:text-white cursor-pointer transition-colors">Tamales</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-cream-300/70">
                <li className="flex items-center gap-2">
                  <MapPin className="w-3.5 h-3.5" /> {businessInfo.address}
                </li>
                <li className="flex items-center gap-2">
                  <Clock className="w-3.5 h-3.5" /> {businessInfo.order_hours.open} - {businessInfo.order_hours.close}
                </li>
                <li className="flex items-center gap-2">
                  <Phone className="w-3.5 h-3.5" /> +53 5680 3949
                </li>
                <li className="flex items-center gap-2">
                  <Instagram className="w-3.5 h-3.5" /> {businessInfo.social}
                </li>
              </ul>
            </div>
            <div>
              ...
              <button
                ...
                className="mt-4 inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-cream-300/80 hover:text-white bg-cream-800/30 hover:bg-cream-800/50 rounded-full transition-all"
              >
                Panel Admin
              </button>
            </div>
          ...
          <div className="border-t border-cream-800/50 mt-10 pt-6 text-center">
            <p className="text-xs text-cream-400/50">© 2026 ¡MAS! Alamar. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
